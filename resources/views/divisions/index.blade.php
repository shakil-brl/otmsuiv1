                                        ...
                                        <th class="w-10px pe-2">
                                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                <input class="form-check-input" data-kt-check="true"
                                                    ...
                                                    type="checkbox" value="" name="all-division" id="all-division" />
                                            </div>
                                        </th>
                                        <th class="min-w-125px">{{ __('division-list.id') }}</th>
                                        <th class="">{{ __('division-list.division_code') }}</th>
                                        <th class="">{{ __('division-list.division_name') }}</th>
                                        <th class="text-end">{{ __('division-list.action') }}</th>
                                    </tr>
                                </thead>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
                            ...
                            let divisionTr = `
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 editDivision" 
                                        data-division-id="${division.id}" data-bs-toggle="modal" data-bs-target="#edit_division">
                                            <i class="ki-duotone ki-pencil fs-2">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>
                                        </a>
                                        <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm  delete-division" 
                                        data-division-id="${division.id}" data-division-name="${division.Name}">
            ...
            $('[name="all-division"]').on('click', function() {
                if ($(this).is(':checked')) {
                    $.each($('.division-item'), function() {
