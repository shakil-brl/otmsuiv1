                ...
                <form id="permission_add_form" method="post" class="form m-7" action="">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7">
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fw-semibold fs-6 mb-2">{{__('roles-permissions.permission_name_ph')}}</label>
                            <!--end::Label-->
            ...
            <div class="modal-content">
                ...
                <form id="permission_edit_form" method="post" class="form m-7" action="">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7">
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fw-semibold fs-6 mb-2">{{__('roles-permissions.permission_name')}}</label>
                            <!--end::Label-->
                            <input type="hidden" name="permission_id" id="permission_id" value="" />
                            <!--begin::First Name-->
                            <input type="text" placeholder="{{__('roles-permissions.permission_name_ph')}}" type="text" id="name"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Email-->
                            <input type="text" placeholder="{{__('roles-permissions.route_names_ph')}}" type="text" id="route_name"
                                name="route_name" autocomplete="off" class="form-control form-control-solid mb-3 mb-lg-0"
                                value="" />
                            <span class="text-danger form-message-error-route_name">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Mobile-->
                            <input type="text" placeholder="{{__('roles-permissions.guard_names_ph')}}" type="text" id="guard_name"
                                name="guard_name" autocomplete="off" class="form-control form-control-solid mb-3 mb-lg-0"
                                value="" />
                            <span class="text-danger form-message-error-guard_name">
