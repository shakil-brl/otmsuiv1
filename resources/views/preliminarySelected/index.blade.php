            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                        {{ __('preliminary-selected.preliminary_selected_list') }}</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href=""class="text-muted text-hover-primary">{{ __('preliminary-selected.preliminary_selected_user') }}</a>
                        </li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                ...
                <div class="card">
                    ...
                    <div class="card-body py-4">
                        <div class="pb-4">
                            ...
                            <form action="" id="targeted_search_form" method="post" class="w-100">
                                ...
                                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 mb-3">
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1">
                                        <input type="text" data-kt-user-order-filter="search"
                                            class="form-control form-control-solid" placeholder="{{ __('preliminary-selected.search_reg_id') }}"
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1">
                                        <input type="text" data-kt-user-order-filter="search"
                                            class="form-control form-control-solid" placeholder="{{ __('preliminary-selected.search_by_name') }}"
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1">
                                        <input type="text" data-kt-user-order-filter="search"
                                            class="form-control form-control-solid" placeholder="Search by Mobile"
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1">
                                        <select name="division_id" aria-label="Select a Division" data-control="select2"
                                            data-placeholder="Select a Division..." class="form-select form-select-solid"
                                            id="division_search">
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1">
                                        <select name="district_id" aria-label="Select a District" data-control="select2"
                                            data-placeholder="Select a District..." class="form-select form-select-solid"
                                            id="district_search">
                                            <option value="">Select Districts</option>
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1">
                                        <select name="upazila_id" aria-label="Select a Upazila" data-control="select2"
                                            data-placeholder="Select a Upazila..." class="form-select form-select-solid"
                                            id="upazila_search">
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1 gap-2">
                                        <a href="" class="btn btn-sm fw-bold btn-danger"
                                            id="clear-search-form">Clear</a>
                                        <a href="" class="btn btn-sm fw-bold btn-success"
                                            id="refresh-page">Refresh</a>
                                    </div>
                                </div>
                                <!--begin::Toolbar-->
                            ...
                            <table class="table table-responsive align-middle table-row-dashed fs-6 gy-5"
                                ...
                                <thead>
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Upazila</th>
                        ...
                        <div class="text-center my-5">
                            <button type="button" class="btn btn-primary" id="final-select-button">
                                Final Select
                            </button>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/dist/assets/js/custom/call.preliminary-selected.user.api.js') }}"></script>
