                        ...
                        <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                            ...
                            <div class="card-body p-9">
                                ...
                                <div class="row mb-7">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <span class="fw-bold fs-6 text-gray-800 reg-id" id="reg-id"></span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
                                ...
                                <div class="row mb-7">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <span class="fw-bold fs-6 text-gray-800 user-full-name" id="user-full-name"></span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
                                ...
                                <div class="row mb-7">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <span class="fw-semibold text-gray-800 fs-6 username" id="username"></span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-7">
                                    ...
                                    <div class="col-lg-8 d-flex align-items-center">
                                        <span class="fw-bold fs-6 text-gray-800 me-2" id="email"></span>
                        ...
                        <div class="card mb-5 mb-xl-10" id="kt_profile_edit_view">
                            ...
                            <div class="card mb-5 mb-xl-10">
                                ...
                                <div id="kt_account_settings_profile_details" class="collapse show">
                                    <!--begin::Form-->
                                    <form class="form" id="user_profile_update_form" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body border-top p-9">
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label
                                                    class="col-lg-4 col-form-label fw-semibold fs-6">{{ __('profile.image') }}</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <!--begin::Image input-->
                                                    <div class="image-input image-input-outline"
                                                        ...
                                                        <span
                                                            ...
                                                            title="Remove avatar" id="remove-photo-url">
                                                            <i class="ki-duotone ki-cross fs-2">
                                                                <span class="path1"></span>
                                                                <span class="path2"></span>
                                                            </i>
                                                    ...
                                                    <!--end::Hint-->
                                                    <span class="form-message-error-image_url">
                                                    </span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 fv-row">
                                                            <input type="text" name="fname"
                                                                ...
                                                                value="" />
                                                            <span class="form-message-error-fname">
                                                            </span>
                                                        </div>
                                                        <!--end::Col-->
                                                        <!--begin::Col-->
                                                        <div class="col-lg-6 fv-row">
                                                            <input type="text" name="lname"
                                                                ...
                                                                value="" />
                                                            <span class="form-message-error-lname">
                                                            </span>
                                                        </div>
                                                        <!--end::Col-->
                                                    </div>
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    ...
                                                    <!--end::Options-->
                                                    <span class="form-message-error-gender">
                                                    </span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    <input type="tel" name="father_name"
                                                        ...
                                                        value="" />
                                                    <span class="form-message-error-father_name">
                                                    </span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    <input type="tel" name="mother_name"
                                                        ...
                                                        value="" />
                                                    <span class="form-message-error-mother_name">
                                                    </span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    ...
                                                    <span class="form-message-error-phone_number">
                                                    </span>
                                                </div>
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    ...
                                                    <span class="form-message-error-nid">
                                                    </span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    <input type="date" name="dob" id="birthday" value=""
                                                        class="form-control form-control-lg form-control-solid" />
                                                    <span class="form-message-error-dob">
                                                    </span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8 fv-row">
                                                    <input type="number" name="b_certificate"
                                                        class="form-control form-control-lg form-control-solid"
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    ...
                                                    <div class="d-flex align-items-center mt-3">
                                                        ...
                                                        <label
                                                            ...
                                                            <input class="form-check-input" name="past_training"
                                                                type="radio" value="1" id="yesRadio" />
                                                            <span
                                                        ...
                                                        <label
                                                            class="form-check form-check-custom form-check-inline form-check-solid">
                                                            <input class="form-check-input" name="past_training"
                                                                type="radio" value="0" checked id="noRadio" />
                                                            <span
                                                    ...
                                                    <!--end::Options-->
                                                    <span class="form-message-error-past_training"></span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="row mb-6 d-none" id="past_course_name_row">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    <input type="text" name="past_course_name"
                                                        ...
                                                        value="" />
                                                    <span class="form-message-error-past_course_name">
                                                    </span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="row mb-6 d-none" id="past_course_duration_row">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    <input type="text" name="past_course_duration"
                                                        ...
                                                        value="" />
                                                    <span class="form-message-error-past_course_duration">
                                                    </span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="row mb-6 d-none" id="past_provider_row">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    <input type="text" name="past_provider_id"
                                                        ...
                                                        value="" />
                                                    <span class="form-message-error-past_provider_id">
                                                    </span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    ...
                                                    <span class="form-message-error-bank_id">
                                                    </span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    ...
                                                    <span class="form-message-error-bkash_id">
                                                    </span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    <select name="category_id"
                                                        aria-label="{{ __('profile.category_ph') }}"
                                                        data-control="select2"
                                                        data-placeholder="{{ __('profile.category_ph') }}"
                                                        class="form-select form-select-solid" data-dropdown-parent=""
                                                        id="category_id">
                                                    </select>
                                                    <span class="form-message-error-category_id"></span>
                                                </div>
                                            </div>
                                            <!--end::Input group-->
                                            <!-- For sub_category_id -->
                                            <div class="row mb-6">
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                                    {{ __('profile.sub_category') }}
                                                </label>
                                                <div class="col-lg-8 fv-row">
                                                    <select name="sub_category_id"
                                                        aria-label="{{ __('profile.sub_category_ph') }}"
                                                        data-control="select2"
                                                        data-placeholder="{{ __('profile.sub_category_ph') }}"
                                                        class="form-select form-select-solid" data-dropdown-parent=""
                                                        id="sub_category_id">
                                                    </select>
                                                    <span class="form-message-error-sub_category_id"></span>
                                                </div>
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-4 col-md-9 col-sm-12">
                                                    <input type="file" name="ssc_certificate" id="ssc_certificate"
                                                        class="form-control">
                                                    <span class="form-message-error-ssc_certificate">
                                                    </span>
                                                </div>
                                                <!--end::Col-->
                                                <!--begin::Col-->
                                                <div class="col-lg-4 col-md-3 col-sm-12  align-items-center"
                                                    id="existing-ssc">
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-4 col-md-9 col-sm-12">
                                                    <input type="file" name="hsc_certificate" id="hsc_certificate"
                                                        class="form-control">
                                                    <span class="form-message-error-hsc_certificate">
                                                    </span>
                                                </div>
                                                <!--end::Col-->
                                                <!--begin::Col-->
                                                <div class="col-lg-4 col-md-3 col-sm-12" id="existing-hsc">
                                                    <a href="#" class="text-gray-900 text-hover-primary">
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-4 col-md-9 col-sm-12">
                                                    <input type="file" name="signature" id="signature"
                                                        class="form-control">
                                                    <span class="form-message-error-signature">
                                                    </span>
                                                </div>
                                                <!--end::Col-->
                                                <!--begin::Col-->
                                                <div class="col-lg-4 col-md-3 col-sm-12" id="existing-signature">
                                                    <a href="#" class="text-gray-900 text-hover-primary">
                                    ...
                                    <div class="card-body border-top p-9">
                                        ...
                                        <div class="d-flex flex-wrap align-items-center mb-10">
                                            ...
                                            @if (Session::has('error'))
                                                <div class="text-center mb-3">{{ Session::has('error') }}
                                                </div>
                                            @endif
...
@section('scripts')
    ...
    <script src="{{ asset('assets/dist/assets/js/custom/call.profile.api.js') }}"></script>
