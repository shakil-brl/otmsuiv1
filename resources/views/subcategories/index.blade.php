                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('home.index') }}"
                                class="text-muted text-hover-primary">{{ __('sub-categorie-list.home') }}</a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a
                                href=""class="text-muted text-hover-primary">{{ __('sub-categorie-list.sub_categorie') }}</a>
                        </li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div id="kt_user_report_views_export_menu"
                                ...
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3"
                                        data-kt-user-export="copy">{{ __('sub-categorie-list.copy_clipboard') }}</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3"
                                        data-kt-user-export="excel">{{ __('sub-categorie-list.export_excel') }}</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3"
                                        data-kt-user-export="csv">{{ __('sub-categorie-list.sub_categorie_list') }}</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3"
                                        data-kt-user-export="pdf">{{ __('sub-categorie-list.export_pdf') }}</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu-->
                            ...
                            <div class="d-flex justify-content-end px-3" data-kt-user-table-toolbar="base">
                                <!--begin::Add user-->
                                <a href="" type="button" class="btn btn-primary select-category"
                                    data-bs-toggle="modal" data-bs-target="#create_subcategory">
                                    <i
                                        class="ki-duotone ki-plus fs-2"></i>{{ __('sub-categorie-list.add_sub_categorie') }}</a>
                                <!--end::Add user-->
                            </div>
                            <!--end::Toolbar-->
                        </div>
                                        ...
                                        <th class="w-10px pe-2">
                                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                <input class="form-check-input" data-kt-check="true"
                                                    ...
                                                    type="checkbox" value="" name="all-subcategory"
                                                    id="all-subcategory" />
                                            </div>
                                        </th>
                ...
                <form id="subcategory_add_form" method="post" class="form m-7" action="">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7">
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label
                                class="required fw-semibold fs-6 mb-2">{{ __('sub-categorie-list.sub_categorie_name') }}</label>
                            <!--end::Label-->
                            <!--begin::First Name-->
            ...
            <div class="modal-content">
                ...
                <form id="subcategory_edit_form" method="post" class="form m-7" action="">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7">
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fw-semibold fs-6 mb-2">{{ __('sub-categorie-list.sub_categorie_name') }}</label>
                            <!--end::Label-->
                            <input type="hidden" name="subcategory_id" id="subcategrory_id" value="" />
                            <!--begin::First Name-->
                            <input type="text" placeholder="{{ __('sub-categorie-list.sub_categorie_name_ph') }}" type="text" id="name"
