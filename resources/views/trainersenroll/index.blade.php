        ...
        <div class="modal-dialog modal-dialog-centered mw-950px">
            <div class="modal-content">
                <div class="modal-header" id="kt_modal_update_provider_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bold">Trainer Enroll With Batch</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="text-center mb-13">
                        ...
                        <!--end::Title-->
                        <div class="text-muted fw-semibold fs-5">Email:
                            <span id="trainer-email"></span>
                        </div>
                        <div class="text-muted fw-semibold fs-5">Phone:
                            <span id="trainer-phone"></span>
                        </div>
                        <!--begin::Description-->
                        <div class="text-muted fw-semibold fs-5">Address:
                            <span id="trainer-address"></span>
                        </div>
                        <!--begin::SubTitle-->
                        <div class="text-muted fw-semibold fs-5">Course Title::
